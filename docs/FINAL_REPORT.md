...
| 개발 인원 | 4명 (김다흰 총괄기획/AI, 박은비 프론트엔드, 박제연 백엔드/DB, 이준일 문서/테스트) |
...
| 이름 | 구분 | 주요 역할 |
|------|------|----------|
| 김다흰 | 총괄기획/AI | 기획, 전체 일정 관리, 백엔드 AI 기능 개발 |
| 박은비 | 프론트엔드 | UI/UX 관리, 화면 구현 설계, 프론트엔드 개발 |
| 박제연 | 백엔드/DB | 백엔드 웹 기능 개발, DB 설계 |
| 이준일 | 문서/테스트 | 기술 문서 작성 관리, 단위 및 통합 테스트 관리 |
